    ...
    <div className="py-8 first:pt-0 last:pb-0">
      <div className="flex gap-x-5">
        ...
        <div>
          ...
          <p className="mt-1 text-gray-500">
            If you lose the link for a theme you purchased, dont panic! We have got you covered. You can login to your account, tap your avatar in the upper right corner, and tap Purchases. If you didnt create a login or cant remember the information, you can use our handy Redownload page, just remember to use the same email you originally made your purchases with.
          </p>
        </div>
      </div>
    </div>

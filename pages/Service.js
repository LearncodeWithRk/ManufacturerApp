...
<div className="max-w-[85rem] px-4 py-10 sm:px-6 lg:px-8 lg:py-14 mx-auto">
  <div className="grid sm:grid-cols-2 lg:grid-cols-3 items-center gap-6 md:gap-10">
    ...
    <div className="w-full h-full bg-white shadow-lg rounded-lg p-5 dark:bg-slate-900">
      <div className="flex items-center gap-x-4 mb-3">
        ...
        <div className="flex-shrink-0">
          <h3 className="block text-lg font-semibold text-gray-800 dark:text-white">furniture For Sale</h3>
        </div>
      </div>
      <p className="text-gray-600 dark:text-gray-400">We Create Your Home More Astetic Get Discount From Membership</p>
    </div>
    ...
    <div className="w-full h-full bg-white shadow-lg rounded-lg p-5 dark:bg-slate-900">
      ...
      <p className="text-gray-600 dark:text-gray-400">We Create Your Home More Astetic
Get Discount From Membership</p>
    </div>
